...
import { AdminServiceError } from '../services/admin/errors.js';
import { TwilioProviderError } from '../services/providers/twilio-number-management.service.js';
...
describe('apiErrorHandler', () => {
  ...
  test.each([
    [new AdminServiceError('Email already in use', 409), 409, 'Conflict'],
    [new TwilioProviderError('Twilio rejected the number'), 502, 'Bad Gateway'],
  ])(
